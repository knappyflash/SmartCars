...
"
    ...
    Private Sub QuickTestButton_Click(sender As Object, e As EventArgs) Handles QuickTestButton.Click
        ...
        Me.Label_00.Text = Me.geneticAlgorithm.NeuralNetworks(0).PropogateForward({0, 0})(0).ToString("F2")
        Me.Label01.Text = Me.geneticAlgorithm.NeuralNetworks(0).PropogateForward({0, 1})(0).ToString("F2")
        Me.Label02.Text = Me.geneticAlgorithm.NeuralNetworks(0).PropogateForward({1, 0})(0).ToString("F2")
        Me.Label03.Text = Me.geneticAlgorithm.NeuralNetworks(0).PropogateForward({1, 1})(0).ToString("F2")
    ...
    Private Sub ResetButton_Click(sender As Object, e As EventArgs) Handles ResetButton.Click
        geneticAlgorithm = New GeneticAlgorithm(100, 2, 1, 4, 4)
        QuickTestButton.PerformClick()
    End Sub
